...
library(popbio)
```
Podemos generar una función simple (en tiempo discreto) para proyectar el tamaño poblacional futuro incorporando los parámetros del modelo logístico.
...
out <- dlogistic(N0=2, r=2.8, K=100, t=1000)
n <- out[901:1000]
ntp1 <- n[-1]
nt <- n[-length(n)]
...
¿Qué se observaría al utilizar tasas de crecimiento poblacional menores?
¿Cómo sería este diagrama con los primeros 100 valores?
